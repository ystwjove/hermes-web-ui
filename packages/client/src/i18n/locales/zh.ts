export default {
  ...
  chat: {
    ...
    openInChat: '在对话中打开',
    archiveToHistory: '归档到历史',
    unarchiveFromHistory: '取消历史归档',
    archivedToHistory: '会话已归档到历史',
    unarchivedFromHistory: '会话已取消历史归档',
    archivedBadge: '已归档',
    modelSwitched: '模型已从 {oldName} 切换为 {newName}',
    modelSwitchedTo: '模型已切换为 {newName}',
    modelSwitchQueued: '已排队切换到 {newName}，当前回复结束后生效。',
  },
  ...
  profiles: {
    ...
    selectModel: '默认模型',
    selectModelPlaceholder: '选择模型（可选）',
    selectModelHint: '可选：为新配置设置默认模型，之后可在设置中修改。',
    modelSetFailed: '配置已创建，但设置默认模型失败',
    archivePath: '归档路径',
