export default {
  ...
  chat: {
    ...
    archiveToHistory: 'Arquivar no Histórico',
    unarchiveFromHistory: 'Desarquivar do Histórico',
    archivedToHistory: 'Sessão arquivada no Histórico',
    unarchivedFromHistory: 'Sessão desarquivada do Histórico',
    archivedBadge: 'Arquivada',
    modelSwitched: 'Modelo alterado de {oldName} para {newName}',
    modelSwitchedTo: 'Modelo alterado para {newName}',
    modelSwitchQueued: 'Alteração de modelo para {newName} enfileirada. Ela entrará em vigor após a resposta atual terminar.',
...
jobTriggered: 'Job acionado',
  ...
  profiles: {
    ...
    selectModel: 'Modelo padrão',
    selectModelPlaceholder: 'Selecionar modelo (opcional)',
    selectModelHint: 'Opcionalmente defina o modelo padrão deste novo perfil. Você pode alterá-lo depois nas configurações.',
    modelSetFailed: 'Perfil criado, mas não foi possível definir o modelo padrão',
