export default {
  ...
  chat: {
    ...
    openInChat: 'Ouvrir dans Chat',
    archiveToHistory: 'Archiver dans l’historique',
    unarchiveFromHistory: 'Désarchiver de l’historique',
    archivedToHistory: 'Session archivée dans l’historique',
    unarchivedFromHistory: 'Session désarchivée de l’historique',
    archivedBadge: 'Archivée',
    modelSwitched: 'Modèle changé de {oldName} à {newName}',
    modelSwitchedTo: 'Modèle changé vers {newName}',
    modelSwitchQueued: 'Changement de modèle vers {newName} en attente. Il prendra effet après la réponse en cours.',
...
jobTriggered: 'Job declenche',
  ...
  profiles: {
    ...
    selectModelPlaceholder: 'Sélectionner un modèle (facultatif)',
    selectModelHint: 'Définis éventuellement le modèle par défaut de ce nouveau profil. Tu pourras le modifier plus tard dans les paramètres.',
    modelSetFailed: 'Profil créé, mais le modèle par défaut n’a pas pu être défini',
