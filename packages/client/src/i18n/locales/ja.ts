export default {
  ...
  chat: {
    ...
    openInChat: 'Chat で開く',
    archiveToHistory: '履歴にアーカイブ',
    unarchiveFromHistory: '履歴のアーカイブを解除',
    archivedToHistory: 'セッションを履歴にアーカイブしました',
    unarchivedFromHistory: 'セッションの履歴アーカイブを解除しました',
    archivedBadge: 'アーカイブ済み',
    modelSwitched: 'モデルを {oldName} から {newName} に切り替えました',
    modelSwitchedTo: 'モデルを {newName} に切り替えました',
    modelSwitchQueued: '{newName} へのモデル切り替えを予約しました。現在の応答が完了すると有効になります。',
  ...
  profiles: {
    ...
    selectModel: 'デフォルトモデル',
    selectModelPlaceholder: 'モデルを選択（任意）',
    selectModelHint: '新しいプロファイルのデフォルトモデルを任意で設定できます。後から設定で変更できます。',
    modelSetFailed: 'プロファイルは作成されましたが、デフォルトモデルを設定できませんでした',
    archivePath: 'アーカイブパス',
