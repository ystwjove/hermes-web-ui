export default {
  ...
  chat: {
    ...
    openInChat: 'Chat에서 열기',
    archiveToHistory: '기록에 보관',
    unarchiveFromHistory: '기록 보관 해제',
    archivedToHistory: '세션을 기록에 보관했습니다',
    unarchivedFromHistory: '세션의 기록 보관을 해제했습니다',
    archivedBadge: '보관됨',
    modelSwitched: '모델이 {oldName}에서 {newName}(으)로 전환되었습니다',
    modelSwitchedTo: '모델이 {newName}(으)로 전환되었습니다',
    modelSwitchQueued: '{newName}(으)로 모델 전환을 대기열에 넣었습니다. 현재 응답이 끝난 뒤 적용됩니다.',
  ...
  profiles: {
    ...
    selectModel: '기본 모델',
    selectModelPlaceholder: '모델 선택(선택 사항)',
    selectModelHint: '새 프로필의 기본 모델을 선택적으로 설정할 수 있습니다. 나중에 설정에서 변경할 수 있습니다.',
    modelSetFailed: '프로필은 생성되었지만 기본 모델을 설정하지 못했습니다',
    archivePath: '아카이브 경로',
