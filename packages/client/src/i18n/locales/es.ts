export default {
  ...
  chat: {
    ...
    archiveToHistory: 'Archivar en Historial',
    unarchiveFromHistory: 'Desarchivar del Historial',
    archivedToHistory: 'Sesión archivada en Historial',
    unarchivedFromHistory: 'Sesión desarchivada del Historial',
    archivedBadge: 'Archivada',
    modelSwitched: 'Modelo cambiado de {oldName} a {newName}',
    modelSwitchedTo: 'Modelo cambiado a {newName}',
    modelSwitchQueued: 'Cambio de modelo a {newName} en cola. Se aplicará cuando termine la respuesta actual.',
...
jobTriggered: 'Job ejecutado',
  ...
  profiles: {
    ...
    selectModel: 'Modelo predeterminado',
    selectModelPlaceholder: 'Seleccionar modelo (opcional)',
    selectModelHint: 'Opcionalmente define el modelo predeterminado para este nuevo perfil. Puedes cambiarlo después en la configuración.',
    modelSetFailed: 'Perfil creado, pero no se pudo definir el modelo predeterminado',
